...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2021 a las 04:39:39
...
(7, 'PADRE', 'kkkkk', NULL, NULL),
(8, 'nuevo', 'kkkkk', 7, NULL),
(9, 'nuevo1', 'kkkkk', 7, NULL),
(10, 'nuevo2', 'kkkkk', 7, NULL),
(11, 'nuevo3', 'kkkkk', 7, NULL);
...
CREATE TABLE `producto` (
  ...
  `proeditorial` varchar(50) NOT NULL,
  `proautor` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(4, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@tienda.com.ar', NULL),
(5, 'cliente', '4983a0ab83ed86e0e7213c8783940193', 'cliente@mail.com', NULL);
