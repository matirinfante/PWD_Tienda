                    ...
                    <div class="row">
                        ...
                        if ($producto[0]->getProCantstock() > 0) {
                                ...
                                <div class="col-12 product-form-qty">
                                    <div class="quantity">
                                        <input type="number" inputmode="numeric" pattern="[0-9]*"
                                               class="qty form-control qty-input" id="proprecio"
                                               name="proprecio" maxlength="7" min="1" value="1"
                            ...
                            <div class="form-group product-stock col-12 col-sm-9 no-padding">
                                ...
                                <a href="shop.php" class="btn btn-back btn-sm" title="Continúa Comprando"><i
