...
<section class="padre"
    ...
    <div id="index" class="container text-center">
        ...
        <div class="row position-relative m-5">
            <div class="p-1">
                <h1 style="font-family: 'Oswald', sans-serif;font-size: 70px; font-weight: 700;">Torre de <span
                            style="color: darkorange">D4</span>dos</h1>
                <br>
                <br>
                <h3 class="mt-5"
                    style="font-family: 'EB Garamond', serif; font-style: oblique; font-size: 30px; font-weight: 100;">
                    Todo lo que necesitas para tu ludoteca.</h3>
                <h3 class="mt-5"
                    style="font-family: 'EB Garamond', serif; font-style: oblique; font-size: 30px; font-weight: 100; color: black">
